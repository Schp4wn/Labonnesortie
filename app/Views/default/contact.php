...
<?php $this->start('main_content') ?>
    <div class="container-fluid">
        <div class="row">
        <h2 class="text-center">Site réalisé par les 4 fantastiqes de la Madelaine</h2>
        <div class="container">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <textarea name="" id="" cols="30" rows="10" class="form-control" placeholder="Texte message .."></textarea>
                </div>
